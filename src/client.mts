...
export class Client extends BaseClient {
    ...
    bulkBanUsersFromGuild(guild_id: Schemas.SnowflakeType, body: Schemas.BulkBanUsersRequest, reason?: string) {
        return this.post<Schemas.BulkBanUsersResponse>(`/guilds/${guild_id}/bulk-ban`, body, reason);
    }
    ...
    createInteractionResponse(interaction_id: Schemas.SnowflakeType, interaction_token: string, body: Schemas.ApplicationCommandAutocompleteCallbackRequest | Schemas.CreateMessageInteractionCallbackRequest | Schemas.LaunchActivityInteractionCallbackRequest | Schemas.ModalInteractionCallbackRequest | Schemas.PongInteractionCallbackRequest | Schemas.SocialLayerSKUPurchaseEligibilityInteractionCallbackRequest | Schemas.UpdateMessageInteractionCallbackRequest, reason?: string, { with_response }: {
